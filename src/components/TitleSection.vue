  ...
  <section class="section-title">
    <div class="container">
      <div class="text-content">
        <div class="welcome">
          Hi I' m
          <span class="gradientText" style="margin-left: 0px">Yeppioo </span>
        </div>
        <div class="description">👦 <span class="purpleText">Middle School </span> Student</div>
        <div class="description">
          📝 The only way to do
          <span class="purpleText textBackground">great</span> is to
    ...
    <div @click.prevent="scrollToMeSection" class="scroll-down-arrow">
      <svg
        ...
        height="32">
        <path
          d="M346.453333 396.373333L512 561.92l165.546667-165.546667a42.496 42.496 0 1 1 60.16 60.16l-195.84 195.84a42.496 42.496 0 0 1-60.16 0L285.866667 456.533333a42.496 42.496 0 0 1 0-60.16c16.64-16.213333 43.946667-16.64 60.586666 0z"
          fill="aliceblue"
          p-id="7433"></path>
      </svg>
    </div>
...
@font-face {
  font-family: 'title';
  src: url(/src/assets/static/Pacifico-Regular.ttf);
}
...
.image-content {
  opacity: 0; /* Initial state for animation */
  transform: scale(0); /* Initial state for scale-in animation */
...
.image-content img {
  ...
  height: 300px;
  border-radius: 50%;
  animation: breathe 2s infinite; /* 应用呼吸动画 */
}
...
.iconItem {
  ...
  opacity: 0;
  animation: iconItemIn 0.5s ease-out forwards;
}
...
@media (max-width: 968px) {
  .section-title .container {
    flex-direction: column-reverse; /* 使头像在文字上方 */
    gap: 30px; /* 调整小屏幕下的间距 */
  }

  .text-content {
    text-align: center;
    max-width: 100%; /* 小屏幕下文字内容宽度占满 */
  }
  ...
  .image-content {
    margin-top: 20px; /* 头像在上方时增加顶部间距 */
    margin-bottom: 0; /* 移除底部间距 */
  }

  .image-content img {
    width: 200px; /* 小屏幕下头像尺寸调整 */
    height: 200px;
  }
